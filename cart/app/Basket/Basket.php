...
class Basket
{
    ...
    public function add(Product $product, $quantity)//add
    {
        if ($this->has($product)) {
    ...
    public function update(Product $product, $quantity)//update
    {
    ...
    public function remove(Product $product)//remove
    {
        $this->storage->unset($product->id);
    }
    
    public function has(Product $product)//checking of product
    {
        return $this->storage->exists($product->id);
    }

    public function get(Product $product)// get
    {
