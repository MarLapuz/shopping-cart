...
mysqli_select_db($connect , "soleddb");
$query = mysqli_query($connect, "SELECT * FROM users WHERE email ='".$_POST['username']."' AND password = '" . $_POST['password']."'");
              ...
              <ul class="dropdown-menu login-panel bgdrop-down">
                <li>
                  <div class="dropdown-header">
                    ...
                    <span class="sign-up"><a href="register.php" class="sign-up">Sign-Up</a></span>
                  </div>
                  <div class="clearfix"></div>
                  <div style="padding: 8px;">
                    <form id="loginform" method="POST" class="form-horizontal" role="form" autocomplete="off">
                      ...
                      <div style="margin-bottom: 10px" class="input-group">
                        ...
                        <input id="login-password" type="password" class="form-control" name="password" placeholder="password" pattern=".{5,}" title="Minmimum 5 letters or numbers."
                          oninvalid="this.setCustomValidity('Enter a password')" oninput="setCustomValidity('')" required>
                      </div>
